...
@section('content')
    <form method="POST" action="{{ route('admin.shippers.update', $shipper) }}">
        @csrf
        @method('PUT')
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group @if($errors->has('title'))has-error @endif">
                            ...
                            <input id="title" class="form-control" placeholder="например: ООО АТИС" name="title" value="{{ old('title', $shipper->title) }}" required>
                            @if ($errors->has('title'))
                        ...
                        <div class="form-group @if($errors->has('number'))has-error @endif">
                            ...
                            <input type="text" id="number" class="form-control" name="number" value="{{ old('number', $shipper->number) }}">
                        ...
                        <div class="form-group @if($errors->has('email'))has-error @endif">
                            ...
                            <input type="email" id="email" class="form-control" name="email" value="{{ old('email', $shipper->email) }}">
                            @if ($errors->has('email'))
                        ...
                        <div class="form-group @if($errors->has('code_product'))has-error @endif">
                            ...
                            <input type="text" id="code_product" class="form-control" name="code_product" value="{{ old('code_product', $shipper->code_product) }}" required>
                        ...
                        <div class="form-group @if($errors->has('address'))has-error @endif">
                            ...
                            <input type="text" id="address" class="form-control" name="address" value="{{ old('address', $shipper->address) }}">
                        ...
                        <div class="form-group @if($errors->has('url'))has-error @endif">
                            ...
                            <input type="url" id="url" class="form-control" placeholder="Пример: http://atis36.ru" name="url" value="{{ old('url', $shipper->url) }}">
                            @if ($errors->has('url'))
                        ...
                        <div class="form-group @if($errors->has('slug'))has-error @endif">
                            ...
                            <input type="text" id="slug" class="form-control" name="slug" value="{{ old('slug', $shipper->slug) }}" required>
                            @if ($errors->has('slug'))
