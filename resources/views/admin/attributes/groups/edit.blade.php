                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group @if($errors->has('title'))has-error @endif">
                            ...
                            <input id="title" class="form-control" placeholder="например: BOSCH" name="title" value="{{ old('title', $brand->title) }}" required>
                            @if ($errors->has('title'))
                        ...
                        <div class="form-group @if($errors->has('slug'))has-error @endif">
                            ...
                            <input type="text" id="slug" class="form-control" name="slug" value="{{ old('slug', $brand->slug) }}" required>
                            @if ($errors->has('slug'))
