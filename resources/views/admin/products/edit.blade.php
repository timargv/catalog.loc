                ...
                <div class="box box-solid">
                    <div class="box-body">
                        <div class="btn-group-sm">
                            ...
                            <button class="btn btn-success float-right">{{ __('button.Save') }}</button>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        @if($photo->type == 'no')
                                            <li class="col-xs-6 pr-0 mb-3">
                                                <div class="position-relative">
                                                    ...
                                                    <form action="{{ route('admin.products.photos.delete', [$product, $photo->id]) }}">
                                                        <button class="far fa-times-circle btn btn-xs btn-flat bg-transparent text-danger position-absolute fixed-bottom py-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Удалить"></button>
                                                    </form>

                                                    <form action="{{ route('admin.products.photos.main', [$product, $photo->id]) }}">
                                                        <button class="far fa-check-circle btn btn-xs btn-flat bg-transparent text-info position-absolute fixed-top py-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Сделать"></button>
                                                    </form>
                                                </div>
                                            </li>
                                        @endif
