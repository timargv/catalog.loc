<form method="POST" action="{{ route('admin.widgets.category.add', $widget) }}">
    @csrf
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-info">
                ...
                <div class="box-body">
                    <select id="widgetProduct" name="widgetItemId" class="form-control select2 w-100" data-placeholder="Выберите Товары">
                        <option value="">-</option>
