@if(request()->all())
<a href="?" class="btn bg-catalog text-white btn-sm ml-3" data-toggle="tooltip" data-placement="top" title="Очистить Поиск"><i class="far fa-redo-alt"></i> Сбросить фильтр</a>
